Public Class frm_mantenimiento_modelos
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.TabPage1.Controls.Add(Me.txt_unidades)
        ...
        Me.txt_unidades.Location = New System.Drawing.Point(80, 104)
        Me.txt_unidades.Name = "txt_unidades"
        Me.txt_unidades.Size = New System.Drawing.Size(100, 21)
        ...
        Me.dgv_listado.Location = New System.Drawing.Point(16, 15)
        Me.dgv_listado.Name = "dgv_listado"
        Me.dgv_listado.ReadOnly = True
        Me.dgv_listado.RowHeadersWidth = 25
        Me.dgv_listado.Size = New System.Drawing.Size(330, 228)
        Me.dgv_listado.TabIndex = 3
        '
        'btn_eliminar
        '
...
#End Region
    ...
    Public Mostrar_Unidades As Boolean = True

    Private Sub frm_mantenimiento_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        aplicar_seguridad()
        llenar_grid()
        Me.tabcontrol1.SelectedTab = Me.TabPage2
        If Mostrar_Unidades Then
            Me.txt_unidades.Visible = True
        Else
            Me.txt_unidades.Visible = False
        End If
    ...
    Private Sub llenar_grid()
        ...
        Try
            ...
            Me.dgv_listado.DataSource = otabla
            'Me.DataGrid1.DataSource = otabla
            'clgen.Alinea_Grid(otabla, Me.DataGrid1, otabla.TableName, -1, 200, 0, True, False, "", True, "")
            clgen.Alinear_GridView(otabla, Me.dgv_listado, ",descripcion,marca,unidades", ",cod_marca,", "", "", True, True, 200, 0)
        Catch ex As Exception
    ...
    Private Sub btn_grabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_grabar.Click
        ...
        If btn_grabar.Text = "Guardar" Then
            ...
            Else
                nombre_sp = "call pa_ins_um_" & nombre_tabla & " (" & Me.cmb_tabla.SelectedValue.ToString & " ,'" & Me.txt_descripcion.Text & "'" & IIf(Mostrar_Unidades, "," & Me.txt_unidades.Text & ")", ")")
            End If
        ...
        Else
            ...
            Else
                nombre_sp = "call pa_upd_um_" & nombre_tabla & " (" & Me.cmb_tabla.SelectedValue.ToString & "," & Me.txt_codigo.Text & ", '" & Me.txt_descripcion.Text & "'" & IIf(Mostrar_Unidades, "," & Me.txt_unidades.Text & ")", ")")
            End If
    ...
    Private Sub dgv_listado_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_listado.DoubleClick
        ...
        Me.txt_codigo.Text = Me.dgv_listado.Item(0, nrow).Value
        Me.txt_descripcion.Text = Me.dgv_listado.Item(1, nrow).Value
        If Mostrar_Unidades Then
            Me.txt_unidades.Text = Me.dgv_listado.Item(5, nrow).Value
        End If

        If nombre_maestro.Length > 0 Then
            Me.cmb_tabla.Text = Me.dgv_listado.Item(2, nrow).Value
        End If
        Me.tabcontrol1.SelectedTab = Me.TabPage1
