...
Imports System.Xml
Imports System.Text
Public Class frm_procesoarchivos3pl
    ...
    Private Function ProcesarDocumento(ByVal dt3PL As DataTable) As Boolean
        ...
        Dim UniPendientes As Integer = 0

        For Each ofila In dt3PL.Rows
            Dim CantLotes As Integer = 1
            If ofila.Item("existencia2") > 0 Then CantLotes = 2
            If ofila.Item("existencia3") > 0 Then CantLotes = 3
            If ofila.Item("existencia4") > 0 Then CantLotes = 4
            If ofila.Item("existencia5") > 0 Then CantLotes = 5
            UniPendientes = ofila.Item("cantidad")  ' Guarda total de unidades del doc.

            For Lote As Integer = 1 To CantLotes   '  Ciclo lotes por cada ofila
                ...
                'determinar cantidades lotes
                If Lote = 1 Then
                    If ofila.Item("factor") = 1 Then
                        If ofila.Item("verifica_lote").ToString = "N" Then
                            dr.Item("Cantidad") = UniPendientes
                            dr.Item("CantidadIngreso") = UniPendientes
                        Else
                    ...
                    Else
                        If UniPendientes - ofila.Item("existencia") > 0 Then
                            dr.Item("Cantidad") = ofila.Item("existencia")
                            dr.Item("CantidadIngreso") = ofila.Item("existencia")
                            dr.Item("Lote") = ofila.Item("lote")
                            dr.Item("fechavcto") = ofila.Item("fechavcto")
                            UniPendientes = UniPendientes - ofila.Item("existencia")
                            Oflex.ods.Tables("detalle").Rows.Add(dr)
                        Else
                            dr.Item("Cantidad") = UniPendientes
                            dr.Item("CantidadIngreso") = UniPendientes
                    ...
                    ElseIf Lote = 2 Then
                    If ofila.Item("factor") = 1 Then
                        dr.Item("Cantidad") = ofila.Item("existencia2")
                        dr.Item("CantidadIngreso") = ofila.Item("existencia2")
                        dr.Item("Lote") = ofila.Item("lote2")
                        dr.Item("fechavcto") = ofila.Item("fechavcto2")
                        Oflex.ods.Tables("detalle").Rows.Add(dr)
                    Else
                        If UniPendientes - ofila.Item("existencia2") > 0 Then
                            dr.Item("Cantidad") = ofila.Item("existencia2")
                            dr.Item("CantidadIngreso") = ofila.Item("existencia2")
                            dr.Item("Lote") = ofila.Item("lote2")
                            dr.Item("fechavcto") = ofila.Item("fechavcto2")
                            UniPendientes = UniPendientes - ofila.Item("existencia2")
                            Oflex.ods.Tables("detalle").Rows.Add(dr)
                        Else
                            dr.Item("Cantidad") = UniPendientes
                            dr.Item("CantidadIngreso") = UniPendientes
                    ...
                    ElseIf Lote = 3 Then
                    If ofila.Item("factor") = 1 Then
                        dr.Item("Cantidad") = ofila.Item("existencia3")
                        dr.Item("CantidadIngreso") = ofila.Item("existencia3")
                        dr.Item("Lote") = ofila.Item("lote3")
                        dr.Item("fechavcto") = ofila.Item("fechavcto3")
                        Oflex.ods.Tables("detalle").Rows.Add(dr)
                    Else
                        If UniPendientes - ofila.Item("existencia3") > 0 Then
                            dr.Item("Cantidad") = ofila.Item("existencia3")
                            dr.Item("CantidadIngreso") = ofila.Item("existencia3")
                            dr.Item("Lote") = ofila.Item("lote3")
                            dr.Item("fechavcto") = ofila.Item("fechavcto3")
                            UniPendientes = UniPendientes - ofila.Item("existencia3")
                            Oflex.ods.Tables("detalle").Rows.Add(dr)
                        Else
                            dr.Item("Cantidad") = UniPendientes
                            dr.Item("CantidadIngreso") = UniPendientes
                    ...
                    ElseIf Lote = 4 Then
                    If ofila.Item("factor") = 1 Then
                        dr.Item("Cantidad") = ofila.Item("existencia4")
                        dr.Item("CantidadIngreso") = ofila.Item("existencia4")
                        dr.Item("Lote") = ofila.Item("lote4")
                        dr.Item("fechavcto") = ofila.Item("fechavcto4")
                        Oflex.ods.Tables("detalle").Rows.Add(dr)
                    Else
                        If UniPendientes - ofila.Item("existencia4") > 0 Then
                            dr.Item("Cantidad") = ofila.Item("existencia4")
                            dr.Item("CantidadIngreso") = ofila.Item("existencia4")
                            dr.Item("Lote") = ofila.Item("lote4")
                            dr.Item("fechavcto") = ofila.Item("fechavcto4")
                            UniPendientes = UniPendientes - ofila.Item("existencia4")
                            Oflex.ods.Tables("detalle").Rows.Add(dr)
                        Else
                            dr.Item("Cantidad") = UniPendientes
                            dr.Item("CantidadIngreso") = UniPendientes
                    ...
                    ElseIf Lote = 5 Then
                    If ofila.Item("factor") = 1 Then
                        dr.Item("Cantidad") = ofila.Item("existencia5")
                        dr.Item("CantidadIngreso") = ofila.Item("existencia5")
                        dr.Item("Lote") = ofila.Item("lote5")
                        dr.Item("fechavcto") = ofila.Item("fechavcto5")
                        Oflex.ods.Tables("detalle").Rows.Add(dr)
                    Else
                        If UniPendientes - ofila.Item("existencia5") > 0 Then
                            dr.Item("Cantidad") = ofila.Item("existencia5")
                            dr.Item("CantidadIngreso") = ofila.Item("existencia5")
                            dr.Item("Lote") = ofila.Item("lote5")
                            dr.Item("fechavcto") = ofila.Item("fechavcto5")
                            UniPendientes = UniPendientes - ofila.Item("existencia5")
                            Oflex.ods.Tables("detalle").Rows.Add(dr)
                        Else
                            dr.Item("Cantidad") = UniPendientes
                            dr.Item("CantidadIngreso") = UniPendientes
            ...
            Next  ' Ciclo lotes   siguiente línea con mismo prod diferente lote.

            '*****************************************************
        Next 'Siguiente línea del documento (nuevo producto)
    ...
    Private Sub crearEstructura()
        ...
        dt3PLMovimiento.Columns.Add(New DataColumn("existencia3", GetType(Double)))
        dt3PLMovimiento.Columns.Add(New DataColumn("lote3", GetType(String)))
        dt3PLMovimiento.Columns.Add(New DataColumn("fechavcto3", GetType(DateTime)))

        dt3PLMovimiento.Columns.Add(New DataColumn("existencia4", GetType(Double)))
        dt3PLMovimiento.Columns.Add(New DataColumn("lote4", GetType(String)))
        dt3PLMovimiento.Columns.Add(New DataColumn("fechavcto4", GetType(DateTime)))

        dt3PLMovimiento.Columns.Add(New DataColumn("existencia5", GetType(Double)))
        dt3PLMovimiento.Columns.Add(New DataColumn("lote5", GetType(String)))
        dt3PLMovimiento.Columns.Add(New DataColumn("fechavcto5", GetType(DateTime)))

        dt3PLMovimiento.Columns.Add(New DataColumn("Empresa", GetType(String)))


        Me.DataGridView1.DataSource = dt3PLMovimiento
        ...
        Try
            ...
            For Each dr As DataRow In dt3PLMovimiento.Rows
                ...
                If dr.Item("documento_numero").ToString.Length = 0 Then
                    Dim lilargo As Integer = dr.Item("tipodocto").ToString.Length
                    lilargo = IIf(lilargo > 19, 20, lilargo)
                    dr.Item("documento_numero") = dr.Item("tipodocto").ToString.Substring(0, lilargo) & "-" & dr.Item("numero").ToString
                End If
                'dr.Item("procesar") = 1
            Next
            ...
            For Each dr As DataRow In dt3PLMovimiento.Rows
                ...
                dr.Item("existencia3") = 0
                dr.Item("existencia4") = 0
                dr.Item("existencia5") = 0

                dtStock.DefaultView.RowFilter = "producto = '" & dr.Item("producto_lgs").ToString.Trim & "' and bodega = '" & dr.Item("bodega").ToString.Trim & "'"
                    ...
                    For Each drViewLote As DataRowView In dtLote.DefaultView
                        If drViewLote.Item("existencia") > 0 Then
                            ...
                            ElseIf iVeces = 3 Then
                                dr.Item("existencia3") = drViewLote.Item("existencia")
                                dr.Item("Lote3") = drViewLote.Item("Lote")
                                dr.Item("fechavcto3") = drViewLote.Item("fechavcto")

                            ElseIf iVeces = 4 Then
                                dr.Item("existencia4") = drViewLote.Item("existencia")
                                dr.Item("Lote4") = drViewLote.Item("Lote")
                                dr.Item("fechavcto4") = drViewLote.Item("fechavcto")

                            ElseIf iVeces = 5 Then
                                dr.Item("existencia5") = drViewLote.Item("existencia")
                                dr.Item("Lote5") = drViewLote.Item("Lote")
                                dr.Item("fechavcto5") = drViewLote.Item("fechavcto")

                            ElseIf iVeces = 6 Then
                                MessageBox.Show("Asignar 6o. lote")
                            End If
                            ...
                            If Integer.Parse(dr.Item("factor")) > 0 Then
                                ...
                                Exit For
                            Else
                                If (dr.Item("existencia") + dr.Item("existencia2") + dr.Item("existencia3") + dr.Item("existencia4") + dr.Item("existencia5")) >= Double.Parse(dr.Item("cantidad").ToString) Then
                                    dr.Item("valido_stock_individual") = "Ok"
                                    Exit For
                                Else
                                    dr.Item("valido_stock_individual") = "Fail"
            ...
            For Each dr As DataRow In validaProducto.Rows
                ...
                For Each drv As DataRowView In dt3PLMovimiento.DefaultView
                    ...
                    If ilineas = 0 Then
                        drv.Item("existencia_calculada") = drv.Item("existencia") + drv.Item("existencia2") + drv.Item("existencia3") + drv.Item("existencia4") + drv.Item("existencia5") + (drv.Item("cantidad") * drv.Item("factor"))
    ...
    Private Sub frm_procesoarchivos3pl_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        crearEstructura()
    End Sub
    ...
    Private Sub DataGridView1_CellPainting(sender As Object, e As DataGridViewCellPaintingEventArgs) Handles DataGridView1.CellPainting
        ...
        Try
            If colIndex > -1 And rowIndex > -1 Then
                ...
                If Me.DataGridView1.Columns(colIndex).Name.ToLower.IndexOf("valido") > -1 Then
                    If Me.DataGridView1.Item(colIndex, rowIndex).Value.ToString = "Ok" Then
                        Me.DataGridView1.Item(colIndex, rowIndex).Style.ForeColor = Color.Green
                    Else
                        Me.DataGridView1.Item(colIndex, rowIndex).Style.ForeColor = Color.Red
                    End If
    ...
    Private Sub btnProcesar3PL_Click(sender As Object, e As EventArgs) Handles btnProcesar3PL.Click
        ...
        Try
            ...
            If MessageBox.Show("¿Desea procesar un nuevo archivo?", "Confirmacion", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Me.DataGridView1.DataSource = dtResultado
    ...
    End Sub
    Private Sub InsertarLineaIngreso()

    End Sub

    Private Sub InsertarLineaSalida()

    End Sub

    Private Sub frm_procesoarchivos3pl_Load()
        crearEstructura()
    End Sub
