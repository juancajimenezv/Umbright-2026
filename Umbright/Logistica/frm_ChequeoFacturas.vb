Public Class frm_ChequeoFacturas
        ...
        If dt.Rows.Count > 0 Then
            ...
            With dt.Rows(0)
                ...
                If .Item("fecha_inicio_chequeo").ToString.Length = 0 Then
                    If MessageBox.Show("Esta Seguro de Asignar Tiempo Inicio", "Confirmacion", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub frm_ChequeoFacturas_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
