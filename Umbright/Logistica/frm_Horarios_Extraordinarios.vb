Public Class frm_Horarios_Extraordinarios
    ...
    Private Sub actualizar_historial(ByVal num_card As String)
        Dim sl_sql As String
        Dim dt As New DataTable
        ...
        Try
            scmTrans.open()
            sl_sql = "pa_sel_um_seg_usuario_horarios_historial '" & num_card & "'"
            ...
            clsGen.Alinear_GridView(dt, Me.dgv_Historial, "", "", ",nombre,fecha,", "", "", "", "", True, True, 250, 0)

        Catch ex As Exception
            MessageBox.Show("ERROR: " & scmTrans.descripcion_error)
    ...
    Private Sub clbx_empleados_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles clbx_empleados.SelectedIndexChanged
