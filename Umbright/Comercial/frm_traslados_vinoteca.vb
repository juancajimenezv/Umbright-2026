Imports System.IO
Public Class frm_traslados_Vinoteca
    Dim Ods As DataSet
    ...
    Private Sub buscarDocumento()
        ...
        Try
            ...
            dt = clsGen.selectQuery("FlexLine", lsSQL)
            'Recalcular el porcentaje asignado
    ...
    Private Sub Label3_Click(sender As Object, e As EventArgs) Handles Label3.Click, Label16.Click, Label15.Click
