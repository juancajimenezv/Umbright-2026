Public Class frmTrackingTrasladosVNT
    ...
    Private Sub Tracking_pedido()
        ...
        Try
            ...
            clsgen.Alinear_GridView(dt, dgDetalle, ",tipodocto,numero,fechaumodif,bodega,total,", "", "", "", ",fechaumodif=fecha facturado,", ",fechaumodif=300,", "", True, True, 250, 100)
    ...
    Private Sub realizarTracking()
        ...
        Dim dr As DataRow
        Dim guia_anterior As String = ""
        Dim sTipoDocumento As String = "SALIDA POR TRASLADO"

        Try

            Me.txtNumeroPedido.Text = Me.txtNumeroPedido.Text.PadLeft(10, "0")
            Crear_Esquema()
            'Me.TabControl1.SelectedTab = Me.TabPage3
            'lirownumber = Me.dg_top_pedidos.CurrentCell.RowNumber
            ...
            ls_sql = " pa_var_um_vn_traslado_encabezado " & Me.txtNumeroPedido.Text
            ...
            Try
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    'Informacion del pedido
                    ls_sql = "pa_sel_um_documento '" & gs_empresa & "','" & sTipoDocumento & "','" &
                        dt.Rows(0).Item("numero_flexline").ToString & "'"
                    '        Me.dg_top_pedidos.Item(lirownumber, 1).ToString & "','" & _
                    '        Me.dg_top_pedidos.Item(lirownumber, 2).ToString & "'"
            ...
            End Try
            'Picking
            ls_sql = "pa_var_um_impresion_picking_factura '" & gs_empresa & "','" &
                    sTipoDocumento & "','" &
                    Me.txt_numero.Text.PadLeft(10, "0") & "'"
            ...
            Try
                ' facturas
                ls_sql = "pa_sel_var_documento_generado_factura '" & gs_empresa & "','" &
                    sTipoDocumento & "','" &
                    Me.txt_numero.Text.PadLeft(10, "0") & "'"
        ...
        Try
            ...
            ls_sql = "pa_sel_um_documento_detalle '" & Me.txt_tipo_pedido.Text & "','" & gs_empresa & "','" & Me.txt_numero.Text & "'"

            dt = clsgen.selectQuery("FlexLine", ls_sql)

            Me.dgDetalle.DataSource = dt
            clsgen.Alinear_GridView(dt, dgDetalle, ",producto,glosa,cantidad,", "", "", "", "", "", ",producto,glosa,cantidad,", True, True, 250, 0)
    ...
    Private Sub lbl_controles_asociados_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        mostrarControlesAsociados()
    End Sub

    Private Sub txtNumeroFactura_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtNumeroPedido.Leave
        limpiarForma()
        realizarTracking()
    End Sub
    ...
    Private Sub cmbTipoDocto_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub cmbTipoDocto_SelectedValueChanged(sender As Object, e As EventArgs)

    End Sub



    Private Sub txtNumeroFactura_TextChanged(sender As Object, e As EventArgs) Handles txtNumeroPedido.TextChanged
    ...
    Private Sub btnGenerar_Click_1(sender As Object, e As EventArgs)

    End Sub

    Private Sub txtNumeroPedido_TextChanged(sender As Object, e As EventArgs)
    ...
    Private Sub btnGenerar_Click_2(sender As Object, e As EventArgs) Handles btnGenerar.Click
        LlenarBusqueda
    End Sub

    Private Sub llenarBusqueda()
        Dim lsSQL As String
        Dim clsGen As New ClasesGenerales.General
        Dim dt As DataTable

        Try
            lsSQL = "pa_var_um_vn_traslado_listado '" & Me.dtp_fechaInicio.Value.ToString("dd/MM/yyyy") & "','" & Me.dtp_fechafinal.Value.ToString("dd/MM/yyyy") & "'"
            dt = clsGen.selectQuery("Corporativo", lsSQL)
            Me.dgvListado.DataSource = dt
            clsGen.Alinear_GridView(dt, Me.dgvListado, "", "", "", "", True, True, 250, 0)
    ...
    Private Sub dgvListado_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvListado.CellDoubleClick
        Try
            ...
            Me.limpiarForma()
            Me.txtNumeroPedido.Text = Me.dgvListado.Item("id", e.RowIndex).Value
            Me.realizarTracking()
