...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_pickeador))
...
#End Region
    ...
    Public Sub Llenar_Combo_Chequeador()
        ...
        otrans.open()
        ls_sql = "pa_sel_um_gen_tabcod NULL,'GEN_CHEQUEADOR','" & gs_empresa & "'"
    ...
    ''MAQUILA_TMK','TMK',0,0,'PAQUETES_1208A','CONDICION DE PAGO'"

    Public Sub Llenar_Combo_pago()
        Dim dt As DataTable
        Dim ls_sql As String

        Dim otrans As New Transaccional.Conexion("flexline")
        otrans.open()
        ls_sql = "pa_sel_um_gen_tabcod NULL,'GEN_PAGOVENTAS','" & gs_empresa & "'"
        dt = otrans.Obtiene(ls_sql)
    ...
    Public Sub Llenar_Combo_Bodega()
        Dim dt As DataTable
        Dim ls_sql As String
    ...
    Public Sub Llenar_Combo_ListaPrecio()
        Dim dt As DataTable
        Dim ls_sql As String
        ...
        Me.cmb_nombre_picker.DisplayMember = "lisprecio"
        Me.cmb_nombre_picker.ValueMember = "lisprecio"
        Me.cmb_nombre_picker.DataSource = dt
    ...
    Public Sub Llenar_Combo_area_vinoteca()
        Dim dt As DataTable
        Dim ls_sql As String

        Dim otrans As New Transaccional.Conexion("flexline")
        otrans.open()
        ls_sql = "pa_var_um_area_vinoteca '" & gs_usuario & "'"
        dt = otrans.Obtiene(ls_sql)
