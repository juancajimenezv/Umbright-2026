Public Class frm_listadoFactCosto
    ...
    Private Sub BuscarOrdenesWalmartReimpresion()
        ...
        Try
            Otrans.open()
            lsSQL = "pa_var_um_facturacion_costoP '" & Me.dtpInicioReimpresion.Value.ToString("dd/MM/yyyy") & "','" & Me.dtpFinalReimpresion.Value.ToString("dd/MM/yyyy") & "'"
    ...
    Private Sub BuscarOrdenesWalmart()
        ...
        Try
            ...
            lsSQL = "pa_var_um_facturacion_costoP '" & Me.dtp_fecha_inicio.Value.ToString("dd/MM/yyyy") & "','" & Me.dtp_fecha_final.Value.ToString("dd/MM/yyyy") & "'"
    ...
    Private Sub imprimirOrdenes()
        ...
        Try
            ...
            For Each drv As DataRowView In dtOrdenes.DefaultView
                Imprimir_Ordenes(drv.Item("numero").ToString)
    ...
    Public Sub Imprimir_Ordenes(ByVal spOrdendeCompra As String)
