...
Public Class frmTrasladoFacturas
    ...
    Private Sub crear_estructuraFEL()
        Dim dt As DataTable
        ...
        Me.dgvListado.DataSource = odsFEL.Tables("pedidos")
    ...
    Private Sub enviosPendientesFEL()
        ...
        ls_sqltxt = "pa_sel_um_tipodocumento_FELPura_empresa '" & gs_empresa & "','" & Me.dtp_listado_inicio.Text & "','" & Me.dtp_listado_final.Text & "',0"
        ...
        Try
            ...
            For Each dr In oTabla.Rows
                ...
                odsFEL.Tables("pedidos").Rows.Add(dr_aux)
            ...
            clGen.Alinear_GridView(odsFace.Tables("pedidos"), dgvListado,
            ...
            ls_sqltxt = "pa_var_um_detalle_felPURA '" & Me.dtpInicio.Text & "','" & Me.dtpFinal.Text & "','" & gs_empresa & "',0"
            oTabla = oTrans.Obtiene(ls_sqltxt)
            oTabla.TableName = "detalle_pedidos"

            odsFace.Tables.Add(oTabla.Copy)
            Me.dgvListado.DataSource = odsFace.Tables("detalle_pedidos")
