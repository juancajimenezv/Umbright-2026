...
#End Region
    ...
    Private Sub hacer_busqueda()
        ...
        Try
            ...
            If otabla.Rows.Count = 0 Then
                ls_SqlScript = "pa_sel_um_consignaciones_saldos_re '" & Me.txt_numero_consignacion.Text & "','" & gs_empresa & "'"
                otabla = oTransaccion.Obtiene(ls_SqlScript)
            End If
            ...
            otabla = oTransaccion.Obtiene(ls_SqlScript)
            If otabla.Rows.Count = 0 Then
                ls_SqlScript = "pa_sel_um_consignaciones_re '" & Me.txt_numero_consignacion.Text & "','" & gs_empresa & "'"
                otabla = oTransaccion.Obtiene(ls_SqlScript)
            ...
            If MessageBox.Show("Esta Seguro de Liberar la Consignacion", "Confirmacion", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                ...
                For i = 0 To otabla.Rows.Count() - 1
                    If otabla.Rows(i).Item("Saldo") > 0 Then
                        ls_SqlScript = "pa_upd_um_consignaciones '" & gs_empresa & "','CONSIGNACIONES','" & Me.txt_numero_consignacion.Text & "','" &
    ...
    Private Sub txt_numero_consignacion_TextChanged(sender As Object, e As EventArgs) Handles txt_numero_consignacion.TextChanged
