...
Public Class frm_dua_HH
    ...
    Private Sub Guardar_Dua()
        ...
        Try
            ...
            ls_sql = "select top 1 no_orden from da_dua_detalle where empresa ='" & gs_empresa & "'and no_orden = '" & Me.txt_ingresoDua.Text.Trim & "'"
            dta = Utrans.Obtiene(ls_sql)
            If dta.Rows.Count > 0 Then
                MessageBox.Show("Numero de Dua ya existe en el sistema", "Informacion", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Else

                ls_sql = "flexline.pa_ins_um_dua_da_pda '" & gs_empresa & "', '" & Me.txt_ingresoDua.Text.Trim & "'"
    ...
    Private Sub Exportar_reporte()
        ...
        Try
            ...
            path_reporte = "\\dataserver\FlexlineServidor\FlexlineERP\Reportes Alianza\Compras e Importaciones\da\informe de recepcion de mercancia ingreso PDA Da julio.rpt"
