...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'Reloj
        '
        Me.Reloj.Interval = 5000
        '
        'cmb_salir
        '
        Me.cmb_salir.FlatStyle = System.Windows.Forms.FlatStyle.Popup
        Me.cmb_salir.Location = New System.Drawing.Point(192, 376)
        ...
        Me.lbl.Name = "lbl"
        Me.lbl.Size = New System.Drawing.Size(264, 327)
        Me.lbl.TabIndex = 2
        '
        'Button1
        '
        Me.Button1.FlatStyle = System.Windows.Forms.FlatStyle.Popup
        Me.Button1.Location = New System.Drawing.Point(104, 376)
        ...
        Me.Text = "Integracion SysGold-FlexLine"
...
#End Region
    ...
    Private Function CrearTablas()
        ...
        Try
            ...
            oTransCE.abrir()
            oTransCE.Ingresa("create table mov_encuesta(empresa nvarchar(25), " & _
                                             "cod_encuesta int, nombre_encuesta nvarchar(50),descripcion nvarchar(100), " & _
                                             "fecha_inicio datetime, fecha_final datetime )")


            oTransCE.Ingresa("create table mov_encuesta_usuario(empresa nvarchar(25), " & _
                                             "cod_encuesta int, usuario nvarchar(50))")

            oTransCE.Ingresa("create table mov_encuesta_modelo_encabezado(empresa nvarchar(25), " & _
                                 "cod_encuesta int, descripcion nvarchar(50), " & _
                                 "label_valor1 nvarchar(50), label_valor2 nvarchar(50), label_valor3 nvarchar(50), " & _
                                 "label_valor4 nvarchar(50), label_valor5 nvarchar(50))")


            oTransCE.Ingresa("create table mov_encuesta_modelo_detalle(empresa nvarchar(25), " & _
                                 "cod_encuesta int, cod_pregunta int, descripcion nvarchar(50), cod_tipo_pregunta int)")

            
            oTransCE.Ingresa("create table mov_encuesta_modelo_detalle_alternativa(empresa nvarchar(25), " & _
                                 "cod_encuesta int, cod_pregunta int,  cod_alternativa int, descripcion nvarchar(50))")



            oTransCE.Ingresa("create table mov_encuesta_resultado_encabezado(empresa nvarchar(25), " & _
                                 "cod_encuesta int, cod_resultado int, usuario_grabo nvarchar(25), fecha_usuario_grabo datetime, " & _
                                 "resultado1 nvarchar(50), resultado2 nvarchar(50), resultado3 nvarchar(50), " & _
                                 "resultado4 nvarchar(50), resultado5 nvarchar(50), estado int)")

            oTransCE.Ingresa("create table mov_encuesta_resultado_detalle_alternativa(empresa nvarchar(25), " & _
    ...
    Private Sub Reloj_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Reloj.Tick
        ...
        Try
            ' CrearTablas()
            myOtrans.abrir()
            ls_sql = "call pa_var_um_pg_procesos_isf ()"
            dt = myOtrans.Obtiene(ls_sql)


            ls_sql = "call pa_sel_um_pg_procesos_isf_adicional()"

            dtAdicional = myOtrans.Obtiene(ls_sql)
            myOtrans.close()


            For Each dr In dt.Rows

                If dr.Item("metodo").ToString.ToLower = "realizar_revision_pedidos_umbright_mobile" Then

                    'Obtener_Pedidos_Umbright_Mobile_EE() 'Enterprise Edition PDA
                    'Procesar_Pedidos_Web("Umbright Mobile EE")

                    Obtener_Pedidos_Umbright_Mobile_SE() 'Standar Edition Celulares
                    Obtener_Pedidos_Tekne()
                    Obtener_Pedidos_Tekne_Mobile_EE() 'Android Tablet


                    Obtener_Pedidos_Tekne_Mobile_SE()

                    Procesar_Archivo_Umbright_Mobile_SE()
                    revision_facturacion_costo()

                    Generar_Pedidos_Umbright_Mobile()  'Proceso Generico
                    Generar_Documentos_Consignaciones()

                    obneterConteosFisicos() 'Conteos Fisicos
                    procesarRecepcionConteosFisicos()

                ElseIf dr.Item("metodo").ToString.ToLower = "realizar_envio_informacion_umbright_mobile ee" Then
                    'Generar_Informacion_Umbright_Mobile_EE() 'Entreprise 24/03/2014 (c)
                    'GenerarInformacion_Tekne_Mobile_EE()
                    Me.generarInformacion(dr.Item("cod_proceso"))

                ElseIf dr.Item("metodo").ToString.ToLower = "realizar_envio_informacion_umbright_mobile se" Then
                    'Generar_Informacion_Umbright_Mobile_SE("") 'Standar

                ElseIf dr.Item("metodo").ToString.ToLower = "realizar_envio_informacion_complementaria" Then
                    'Generar_Informacion_Complementaria_Mobile_EE(dr.Item("cod_proceso").ToString)

                    ' subirPedidoCanastas()
                ElseIf dr.Item("metodo").ToString.ToLower = "realizar_revision_memos_promocionales" Then
                    ' Me.Procesar_Memos_Promocionales(dr.Item("cod_proceso").ToString)
                    Me.memosPromocionales(dr.Item("cod_proceso").ToString)

                ElseIf dr.Item("metodo").ToString.ToLower = "sincronizar_informacion" Then
                    Me.sincronizarInformacionPOS(dr.Item("cod_proceso").ToString)

                ElseIf dr.Item("metodo").ToString.ToLower = "replicacion_informacion_dia" Then
                    Me.replicaInformacion(dr.Item("cod_proceso").ToString)

                ElseIf dr.Item("metodo").ToString.ToLower = "replicacion_informacion_noche" Then
                    Me.replicaInformacion(dr.Item("cod_proceso").ToString)

                ElseIf dr.Item("metodo").ToString.ToLower = "sincronizar_informacion_edifact" Then

                    'Me.obtener_pedidos_access_codicasa(dr.Item("cod_proceso").ToString)
                    'Me.obtener_pedidos_access_dmarte(dr.Item("cod_proceso").ToString)
                    'Me.obtener_pedidos_access_diuva(dr.Item("cod_proceso").ToString)
                    procesarEdifact(dr.Item("cod_proceso").ToString)

                ElseIf dr.Item("metodo").ToString.ToLower = "devolucion" Then
                    procesarDevolucionesyRechazos(dr.Item("cod_proceso").ToString)
                ElseIf dr.Item("metodo").ToString.ToLower = "cambio_precios" Then
                    procesarCambiosPrecios(dr.Item("cod_proceso").ToString)
                ElseIf dr.Item("metodo").ToString.ToLower = "asignacion_picking" Then
                    procesarAsignacionPicking(dr.Item("cod_proceso").ToString)
                End If

            Next

            'Verificar Procesos Extras
            myOtrans.open()
            For Each dr In dtAdicional.Rows
                If dr.Item("modulo").ToString.ToLower = "umbright mobile enterprise" Then
                    Generar_Informacion_Umbright_Mobile_EE_Usuario(dr.Item("metodo").ToString.Split(" ")(1), 0)
                    'Generar_Informacion_Umbright_Mobile_EE_Usuario("lpinzon", 0)
                    myOtrans.Actualiza("call pa_upd_um_pg_procesos_isf_adicional (" & dr.Item("cod_proceso").ToString & ")")
                End If

                If dr.Item("modulo").ToString.ToLower = "umbright mobile standard" Then
                    Generar_Informacion_Umbright_Mobile_SE(dr.Item("metodo").ToString.Split(" ")(1))
                    myOtrans.Actualiza("call pa_upd_um_pg_procesos_isf_adicional (" & dr.Item("cod_proceso").ToString & ")")
                End If
            Next
        Catch ex As Exception
            ClsGen.Escribir_Log("Reloj_Tick " & ex.ToString)
        Finally
            myOtrans.close()
            myOtrans = Nothing
            ClsGen = Nothing
            dt = Nothing
            dr = Nothing
            If Me.lbl.Items.Count > 25 Then Me.lbl.Items.Clear()
    ...
    Private Sub Obtener_Pedidos_Tekne_Mobile_SE()
        ...
        Try
            ...
            For Each drv In dt.DefaultView
                ObtenerPedidos_Tekne_Vendedor(drv)
            Next
    ...
    Private Sub procesarAsignacionPicking(ByVal picodProceso As Integer)
        Dim myOtrans As New Transaccional.Conexion_mysql("onbase")
        Try
            myOtrans.open()
            myOtrans.Actualiza("call pa_upd_um_pg_procesos_isf  (" & picodProceso.ToString & ")")

            Dim oAsignacion As New asignarUsuarioPicking
            oAsignacion.asignarPicking(2)
            oAsignacion = Nothing
            ...
            For Each dr As DataRow In dt.Rows
                If dr.Item("dias_para_procesar") <= 1 Then
                    ...
                    If dr.Item("precioOriginal") > 0 Then
                        ...
                        lsSQL = "pa_upd_um_precio_producto_listaPrecioD '" & dr.Item("empresa") & "', " & _
                                                   dr.Item("idlisprecio") & ", " & dr.Item("precio_nuevo") & _
    ...
    Private Sub revision_facturacion_costo()
        Dim Otrans As New Transaccional.Conexion("flexline")
        Dim myOtrans As New Transaccional.Conexion_mysql("onbase")
        Dim ls_sql As String
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                For Each dr As DataRow In dt.Rows
                    Correlativo += 1
                    ls_sql = "pa_sel_um_listaprecio_costo_traslado '" & dr.Item("empresa") & "'"
                    dt3 = Otrans.Obtiene(ls_sql)

                    ls_sql = "call pa_ins_um_mov_pedidos_encabezado ('" & dr.Item("empresa") & "','" & _
                    Now.ToString("ddMMyyyyHHmmss") & Correlativo & "','" & dr.Item("ctacte_fc") & "','CREDITO 30 DIAS',0,0,'" & _
                   Now.ToString("yyyy-MM-dd HH:mm:ss") & "','" & Now.ToString("yyyy-MM-dd HH:mm:ss") & "','" & _
                    "1900-01-01','SOLICITUD NO. " & dr.Item("numero") & " " & dr.Item("observaciones") & "','" & dr.Item("usuario_grabo") & "',0,'" & dt3.Rows(0).Item("lisprecio") & "','" & _
                    ...
                    If myOtrans.Codigo_error = 0 Then
                        ...
                        For Each drrs As DataRow In dt2.Rows
                            LineaLocal += 1
                            ls_sql = "call pa_ins_um_mov_pedidos_detalle_traslado (" & numero_pedido & "," & _
                                    LineaLocal & ",'" & drrs.Item("producto").ToString & "'," & _
                                    drrs.Item("Cantidad") & "," & drrs.Item("precio") & "," & _
                                    drrs.Item("Cantidad") * drrs.Item("precio") & ",'" & drrs.Item("marca") & _
                                    "','" & drrs.Item("centro_costo") & "','" & drrs.Item("gasto_conta") & "','" & _
                        ...
                        myOtrans.Actualiza(ls_sql)
                        ls_sql = "pa_upd_facturacion_costo_traslado_estado '" & dr.Item("empresa") & "'," & dr.Item("cod_factura")
    ...
    Private Sub procesarEdifact(ByVal iproceso As Integer)
        Dim myOtrans As New Transaccional.Conexion_mysql("Onbase")
        ...
        Try
            ...
            'Ejecutamos el proceso
            proceso.StartInfo.FileName = "c:\aplicaciones\edifact\edifact.exe"
            'El Path o la ubicacion del archivo
            proceso.StartInfo.WorkingDirectory = "c:\aplicaciones\edifact"
    ...
    Private Sub generarInformacionPOS(ByVal psEmpresa As String, ByVal psUbicacion As String, ByVal pdFecha As DateTime)
        ...
        Try
            ...
            ls_sql = "pa_var_um_documento_traslado_fecha  '" & psEmpresa & "',null,'" & _
            ...
            ''documentod
            ls_sql = "pa_var_um_documentod_traslado_fecha '" & psEmpresa & "',null,'" & _
                        pdFecha.ToString("dd/MM/yyyy") & "','" & pdFecha.ToString("dd/MM/yyyy") & "'"
            ...
            ''documentov
            ls_sql = "pa_var_um_documentov_traslado_fecha '" & psEmpresa & "',null,'" & _
                        pdFecha.ToString("dd/MM/yyyy") & "','" & pdFecha.ToString("dd/MM/yyyy") & "'"
            ...
            ''documentop
            ls_sql = "pa_var_um_documentop_traslado_fecha '" & psEmpresa & "',null,'" & _
                        pdFecha.ToString("dd/MM/yyyy") & "','" & pdFecha.ToString("dd/MM/yyyy") & "'"
            ...
            ''Clientes
            ls_sql = "pa_var_um_ctacte_traslado_fecha '" & psEmpresa & "',null,'" & _
                        pdFecha.ToString("dd/MM/yyyy") & "','" & pdFecha.ToString("dd/MM/yyyy") & "'"
            dt = Otrans.Obtiene(ls_sql)
            dt.TableName = "ctacte"
            ...
            ls_sql = "pa_var_um_ctacteDirecciones_traslado_fecha '" & psEmpresa & "',null,'" & _
                    pdFecha.ToString("dd/MM/yyyy") & "','" & pdFecha.ToString("dd/MM/yyyy") & "'"
            dt = Otrans.Obtiene(ls_sql)
            ...
            ''Direcciones de Clientes
            ls_sql = "pa_var_um_ctacteGenTabCod_traslado_fecha '" & psEmpresa & "',null,'" & _
                        pdFecha.ToString("dd/MM/yyyy") & "','" & pdFecha.ToString("dd/MM/yyyy") & "'"
            dt = Otrans.Obtiene(ls_sql)
...
#Region "Tekne"
    ...
    Private Sub GeneraBDsqlite(ByVal user As String)
        ...
        Try
            ...
            For Each dr1 As DataRow In dtproductos.Rows
                '  SQLcommand = SQLconnect.CreateCommand
                SQLcommand.CommandText = "INSERT INTO mov_venta VALUES ('" & dr1.Item("empresa") & _
                "','" & dr1.Item("ctacte") & _
                "','" & dr1.Item("producto") & _
                "','" & dr1.Item("bu") & _
                "','" & dr1.Item("metau") & _
                ...
                "','" & dr1.Item("promu") & _
                "','" & dr1.Item("promq") & _
                "','" & dr1.Item("pedido_sugerido") & _
                "','" & dr1.Item("visitas_mes") & _
                "','" & dr1.Item("visitas_realizadas") & _
                "','" & dr1.Item("visitas_pendientes") & _
                "','" & dr1.Item("periodo") & "')"
                SQLcommand.ExecuteNonQuery()
            Next
            ...
            For Each dr1 As DataRow In dtproductos.Rows
                '  SQLcommand = SQLconnect.CreateCommand
                SQLcommand.CommandText = "INSERT INTO inv_producto VALUES ('" & dr1.Item("empresa") & _
                "','" & dr1.Item("cod_flex") & _
                "','" & dr1.Item("nombre_producto").ToString.Replace("'", " ") & _
                "','" & dr1.Item("tipo").ToString.Replace("'", " ") & _
                "','" & dr1.Item("familia").ToString.Replace("'", " ") & _
                "','" & dr1.Item("proveedor").ToString.Replace("'", " ") & _
                "','" & dr1.Item("marca").ToString.Replace("'", " ") & _
                "','" & dr1.Item("subtipo").ToString.Replace("'", " ") & _
                "','" & dr1.Item("pais").ToString.Replace("'", " ") & _
                "','" & dr1.Item("cepa").ToString.Replace("'", " ") & _
                "','" & dr1.Item("codigobarra").ToString.Replace("'", " ") & _
                "','" & dr1.Item("generalidades").ToString.Replace("'", " ") & _
    ...
    Private Sub GeneraBDsqliteOld(ByVal user As String)
        Dim myOtrans As New Transaccional.Conexion_mysql("OnBase")
        Dim Otrans As New Transaccional.Conexion("Flexline")
    ...
    Private Sub GeneraBDsqliteOld10032014(ByVal user As String)
        Dim myOtrans As New Transaccional.Conexion_mysql("OnBase")
                ...
                For Each drUsuarios As DataRow In dtUsuarios.Rows
                    ...
                    For Each dr In dtaux.Rows
                        ...
                        If dt.DefaultView.Count > 0 Then
                            ...
                            ls_sql = "call pa_ins_documentosPendientes_saldos_tk ('" & dr.Item("Empresa") & _
                            "','" & dr.Item("ctacte") & "'," & saldototal & "," & saldocorriente & "," & saldo1a30 & "," & _
                        ...
                        For Each drv As DataRowView In ods4.Tables("clientes_envio").DefaultView
                            ...
                            If dt_historial.DefaultView.Count > 0 Then
                                For Each drv2 As DataRowView In dt_historial.DefaultView
                                    ...
                                    dt_saldos.DefaultView.RowFilter = "con_cliente = '" & drv2.Item("con_cliente").ToString & _
                                                                       "' and con_numero = '" & drv2.Item("con_numero").ToString & _
                                                                       "' and con_producto = '" & drv2.Item("con_producto").ToString & _
                                                                       "' and saldo > 0"
    ...
    Private Sub Enviar_Informacion_Sitio_Tekne(ByVal pRuta As String, ByVal dataUser As DataTable, ByVal dataFtp As DataTable)
    ...
    Private Function Procesar_ConsignacionesTekne(ByVal archivoXML As String)
        ...
        Try
            ...
            With dr_encabezado
                ...
                ls_sql = "call pa_ins_um_crm_cliente_producto_consignacion_conteo_encabezado (" & _
                         codempresa & ",'" & encabezado(2).ToString & "','" & _
                         encabezado(3).ToString & "','" & encabezado(5).ToString & "','" & _
                            ...
                            For Each lineas As String In detalle
                                ...
                                If linea.Length > 1 Then
                                    ...
                                    If linea(0).StartsWith(encabezado(0).ToString) Then
                                        ls_sql = "call pa_ins_um_crm_cliente_producto_consignacion_conteo    (" & codempresa & ",'" & _
                                                         codCliente & "','" & linea(2).ToString & "','" & _
                                                         fechaConteo & "'," & linea(3).ToString & ",0,'" & _
...
#Region "Pedidos MR atravez de FTP"
    ...
    Function Procesar_Archivo_Texto(ByVal _Ruta_Archivo As String, ByVal _codigo_cliente As String) As Boolean
        ...
        Dim ls_sql As String
        Dim datos As String()
        Dim svendedor, sruta, snombre, sdireccion, snit, scodigo, szona, _
            ...
            Do Until fs_archivo.Peek = -1
                ...
                If datos.Length = 9 Then
                    ...
                    If validar_factura(_codigo_cliente, datos(1), tipo_movimiento, IIf(tipo_movimiento = 3, 0, datos(3)), lnubicacion) Then
                        ...
                        ls_sql = "call pa_ins_um_bbj_mayorista_encabezado_movimiento_FTP (" & _
                                    ncorrelativo & "," & _codigo_cliente & "," & IIf(tipo_movimiento = 3, "0", datos(3)) & "," & tipo_movimiento & ",'" & _
                                   Date.Parse(datos(2).ToString).ToString("yyyy-MM-dd") & "','Admin'," & Double.Parse(datos(5).ToString).ToString & "," & _
                                    Double.Parse(datos(5).ToString).ToString & ",0,0,'" & _
                ...
                ElseIf datos.Length = 7 Then   'Detalle
                    If nmovimiento > 0 And nlineas > 0 Then
                        If Int64.Parse(datos(3).ToString) > 0 Then
                            nlineas -= 1
                            ls_sql = "call pa_ins_um_bbj_mayorista_detalle_movimiento_FTP (" & nmovimiento & "," & _
...
#Region "Busqueda  y Proceso de Archivos en los directorios de MR"
        ...
        Try
            ...
            For Each dr In _ods.Tables("encabezado_movimiento").Rows
                ...
                If Modificacion Then
                    ...
                    If dr.Item("estado") = 1 Then
                        ...
                        ls_sql = "call pa_var_um_bbj_mayorista_encabezado_movimiento (" & _
                                    dr.Item("correlativo").ToString & "," & dr.Item("cod_cliente").ToString & "," & dr.Item("cod_cliente_mayorista").ToString & "," & _
                        ...
                        If dt.Rows.Count > 0 Then
                            ...
                            For Each dr2 In dt2.Rows
                                ...
                                ls_sql = "call pa_del_um_bbj_mayorista_detalle_movimiento (" & dr2.Item("cod_movimiento").ToString & ",'" & _
                            ...
                            ls_sql = "call pa_del_um_bbj_mayorista_encabezado_movimiento (" & dt.Rows(0).Item("cod_movimiento").ToString & "," & _
                                    dr.Item("correlativo").ToString & "," & dr.Item("cod_cliente").ToString & "," & _
                                    dr.Item("cod_cliente_mayorista").ToString & "," & _
                                    dr.Item("cod_tipo_movimiento").ToString & ")"
                            myOtrans.Elimina(ls_sql)
                            If myOtrans.Codigo_error > 0 Then
                                Resultado = False
                    ...
                    Else
                        ''Modificar Estado
                        ls_sql = "call pa_upd_um_bbj_mayorista_encabezado_movimiento (" & dr.Item("correlativo").ToString & "," & _
                                dr.Item("cod_cliente").ToString & "," & dr.Item("cod_tipo_movimiento").ToString & "," & _
                                dr.Item("estado").ToString & "," & _
                                "NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'" & dr.Item("usuario_modifico") & "','" & _
                ...
                If dr.Item("correlativo") > 0 Then
                    ...
                    ls_sql += dr.Item("correlativo").ToString & "," & dr.Item("cod_cliente").ToString & "," & dr.Item("cod_cliente_mayorista").ToString & "," & _
                                    dr.Item("cod_tipo_movimiento").ToString & ",'" & _
                                    Date.Parse(dr.Item("fecha").ToString).ToString("yyyy-MM-dd") & "','" & dr.Item("usuario_grabo") & "'," & dr.Item("total").ToString & ",'" & _
                                    dr.Item("numero_externo").ToString & "','" & dr.Item("observaciones") & "','" & _
                                    dr.Item("condicion_pago").ToString & "'," & _
                                    IIf(dr.Item("cod_proveedor_mayorista").ToString.Length = 0, "NULL", dr.Item("cod_proveedor_mayorista").ToString) & "," & _
                                    dr.Item("estado").ToString & "," & _
                                    dr.Item("subtotal").ToString & "," & dr.Item("desc_producto").ToString & "," & _
                                    dr.Item("desc_cliente").ToString & ",'" & _
                                    Date.Parse(dr.Item("fecha_grabo").ToString).ToString("yyyy-MM-dd HH:mm") & "'," & _
                                    dr.Item("cod_movimiento").ToString & "," & _
                                    IIf(dr.Item("cod_vendedor").ToString.Length = 0, "NULL", dr.Item("cod_vendedor").ToString) & "," & _
                    ...
                    If nmovimiento > 0 Then
                        ...
                        For Each drv In _ods.Tables("detalle_movimiento").DefaultView
                            ls_sql = "call pa_ins_um_bbj_mayorista_detalle_movimiento_XML (" & nmovimiento.ToString & "," & _
                                 drv.Item("cantidad").ToString & "," & drv.Item("precio").ToString & "," & drv.Item("linea").ToString & ",'" & _
                                 drv.Item("cod_producto_mayorista").ToString & "'," & drv.Item("costo").ToString & "," & drv.Item("subtotal").ToString & "," & _
                                 drv.Item("porc_desc_producto").ToString & "," & drv.Item("porc_desc_cliente").ToString & "," & _
                                 drv.Item("total_desc_producto").ToString & "," & drv.Item("total_desc_cliente").ToString & "," & _
    ...
    Function Subir_Productos_Disponibles_XML(ByVal _odt As DataTable) As Boolean
        ...
        Try
            ...
            For Each dr In _odt.Rows
                ...
                ls_sql = "call pa_sel_um_bbj_mayorista_productos_disponibles (" & dr.Item("cod_cliente").ToString & ",'" & _
                ...
                If dt.Rows.Count > 0 Then
                    Try
                        ...
                        ls_sql = "Call pa_upd_um_bbj_mayorista_productos_disponibles_XML (" & dr.Item("cod_cliente").ToString & "," & _
                                dr.Item("cod_proveedor").ToString & ",'" & dr.Item("cod_producto_mayorista").ToString & "','" & _
                                dr.Item("cod_producto_proveedor").ToString & "','" & dr.Item("descripcion").ToString & "'," & _
                                dr.Item("precio_venta").ToString & "," & dr.Item("precio_proveedor").ToString & "," & _
                                dr.Item("factor_alternativo").ToString & "," & dr.Item("descuento_producto").ToString & "," & _
                                dr.Item("existencia").ToString & "," & dr.Item("minimo").ToString & ",'" & dr.Item("usuario_modifico").ToString & "','" & _
                                fecha_modifico & "')"
                ...
                Else
                    ...
                    ls_sql = "Call pa_ins_um_bbj_mayorista_productos_disponibles_XML (" & dr.Item("cod_cliente").ToString & "," & _
                            dr.Item("cod_proveedor").ToString & ",'" & dr.Item("cod_producto_mayorista").ToString & "','" & _
                            dr.Item("cod_producto_proveedor").ToString & "','" & dr.Item("descripcion").ToString & "'," & _
                            dr.Item("precio_venta").ToString & "," & dr.Item("precio_proveedor").ToString & "," & _
                            dr.Item("factor_alternativo").ToString & "," & dr.Item("descuento_producto").ToString & "," & _
                            dr.Item("existencia").ToString & "," & dr.Item("minimo").ToString & ",'" & dr.Item("usuario_grabo").ToString & "','" & _
    ...
    Function Subir_Ruta_Alias_XML(ByVal _odt As DataTable) As Boolean
        ...
        Try
            myOtrans.open()
            For Each dr In _odt.Rows
                ls_sql = "call pa_upd_um_bbj_mayorista_ruta_alias_XML (" & dr.Item("cod_cliente").ToString & "," & _
                         dr.Item("cod_ruta").ToString & ",'" & dr.Item("descripcion").ToString & "','" & _
                         dr.Item("usuario_grabo").ToString & "','" & _
                         Date.Parse(dr.Item("fecha_grabo").ToString).ToString("yyyy-MM-dd HH:mm") & "')"
                myOtrans.Actualiza(ls_sql)
                If myOtrans.Codigo_error > 0 Then
                    Resultado = False
    ...
    Function Subir_Vendedor_Alias_XML(ByVal _odt As DataTable) As Boolean
        ...
        Try
            myOtrans.open()
            For Each dr In _odt.Rows
                ls_sql = "call pa_upd_um_bbj_mayorista_vendedor_alias_XML (" & dr.Item("cod_cliente").ToString & "," & _
                         dr.Item("cod_vendedor").ToString & ",'" & dr.Item("nombre").ToString & "','" & _
                         dr.Item("usuario_grabo").ToString & "','" & _
                         Date.Parse(dr.Item("fecha_grabo").ToString).ToString("yyyy-MM-dd HH:mm") & "')"
                myOtrans.Actualiza(ls_sql)
                If myOtrans.Codigo_error > 0 Then
    ...
    Function Subir_Clientes_XML(ByVal _odt As DataTable) As Boolean
        ...
        Try
            ...
            For Each dr In _odt.Rows
                ...
                ''Primero debe verificar si existe
                ls_sql = "call pa_sel_um_bbj_mayorista_cliente (" & dr.Item("cod_cliente").ToString & "," & _
                ...
                If dt.Rows.Count = 0 Then
                    ...
                    ls_sql = "call pa_ins_um_bbj_mayorista_cliente_XML (" & dr.Item("cod_cliente").ToString & "," & _
                       dr.Item("cod_cliente_mayorista").ToString & "," & dr.Item("cod_tipo_cliente").ToString & ",'" & _
                        dr.Item("nit").ToString & "','" & dr.Item("nombre").ToString & "','" & dr.Item("propietario").ToString & "'," & _
                        dr.Item("cod_ruta").ToString & ",1" & ",'" & dr.Item("direccion_calle").ToString & "'," & _
                        dr.Item("direccion_zona").ToString & ",'" & dr.Item("direccion_colonia").ToString & "'," & _
                        dr.Item("direccion_municipio").ToString & "," & dr.Item("direccion_departamento").ToString & "," & _
                        dr.Item("direccion_pais").ToString & ",'" & dr.Item("telefono").ToString & "'," & dr.Item("estado").ToString & ",'" & _
                        dr.Item("observaciones").ToString & "'," & dr.Item("orden_visita").ToString & "," & dr.Item("descuento").ToString & ",'" & _
                        dr.Item("usuario_grabo").ToString & "','" & Date.Parse(dr.Item("fecha_grabo").ToString).ToString("yyyy-MM-dd HH:mm") & "'," & _
                ...
                Else
                    Try
                        ...
                        ls_sql = "call pa_upd_um_bbj_mayorista_cliente_XML (" & dr.Item("cod_cliente").ToString & "," & _
                           dr.Item("cod_cliente_mayorista").ToString & "," & dr.Item("cod_tipo_cliente").ToString & ",'" & _
                            dr.Item("nit").ToString & "','" & dr.Item("nombre").ToString & "','" & dr.Item("propietario").ToString & "'," & _
                            dr.Item("cod_ruta").ToString & "," & dr.Item("cod_vendedor").ToString & ",'" & dr.Item("direccion_calle").ToString.Replace("'", "") & "'," & _
                            dr.Item("direccion_zona").ToString & ",'" & dr.Item("direccion_colonia").ToString & "'," & _
                            dr.Item("direccion_municipio").ToString & "," & dr.Item("direccion_departamento").ToString & "," & _
                            dr.Item("direccion_pais").ToString & ",'" & dr.Item("telefono").ToString & "'," & dr.Item("estado").ToString & ",'" & _
                            dr.Item("observaciones").ToString & "'," & dr.Item("orden_visita").ToString & "," & dr.Item("descuento").ToString & ",'" & _
                            dr.Item("usuario_modifico").ToString & "','" & Date.Parse(dr.Item("fecha_modifico").ToString).ToString("yyyy-MM-dd HH:mm") & "'," & _
        ...
        Try
            ...
            For Each dr In _odt.Rows
                ...
                If dt.Rows.Count = 0 Then
                    ...
                    ls_sql = "call pa_ins_um_bbj_mayorista_cliente_XML_temporal (" & dr.Item("cod_cliente").ToString & "," & _
                       dr.Item("cod_cliente_mayorista").ToString & "," & dr.Item("cod_tipo_cliente").ToString & ",'" & _
                        dr.Item("nit").ToString.Trim & "','" & dr.Item("nombre").ToString.Trim.Replace("'", " ") & "','" & dr.Item("propietario").ToString.Trim & "'," & _
                        dr.Item("cod_ruta").ToString.Trim & ",'" & dr.Item("direccion_calle").ToString.Trim & "'," & _
                        dr.Item("direccion_zona").ToString & ",'" & dr.Item("direccion_colonia").ToString & "'," & _
                        Val(dr.Item("direccion_municipio").ToString) & "," & Val(dr.Item("direccion_departamento").ToString) & "," & _
                        dr.Item("direccion_pais").ToString & ",'" & dr.Item("telefono").ToString.Trim & "'," & dr.Item("estado").ToString & ",'" & _
                        dr.Item("observaciones").ToString & "'," & dr.Item("orden_visita").ToString & "," & dr.Item("descuento").ToString & ",'" & _
                        dr.Item("usuario_grabo").ToString & "','" & Date.Parse(dr.Item("fecha_grabo").ToString).ToString("yyyy-MM-dd HH:mm") & "'," & _
                        dr.Item("cod_tipo_localidad_geo") & "," & dr.Item("cod_sucursal").ToString & ")"
                    ...
                    Else
                        Dim ls_filtro As String
                        ls_filtro = "cod_cliente = " & dr.Item("cod_cliente").ToString & _
                                                            " and cod_sucursal = " & dr.Item("cod_sucursal").ToString & _
                        ...
                        If odt_vendedores.DefaultView.Count > 0 Then
                            ls_sql = "call pa_del_um_bbj_mayorista_cliente_vendedor (" & dr.Item("cod_cliente").ToString & "," & _
                        ...
                        For Each drv In odt_vendedores.DefaultView
                            ls_sql = "call pa_ins_um_bbj_mayorista_cliente_vendedor (" & _
                                        drv.Item("cod_cliente").ToString & "," & drv.Item("cod_sucursal").ToString & "," & _
                                        drv.Item("cod_cliente_mayorista").ToString & "," & drv.Item("cod_vendedor").ToString & "," & _
                ...
                Else
                    Try
                        ...
                        Try
                            ls_sql = "call pa_upd_um_bbj_mayorista_cliente_XML (" & dr.Item("cod_cliente").ToString & "," & _
                                dr.Item("cod_cliente_mayorista").ToString & "," & dr.Item("cod_tipo_cliente").ToString & ",'" & _
                                 dr.Item("nit").ToString.Trim & "','" & dr.Item("nombre").ToString.Trim & "','" & dr.Item("propietario").ToString.Trim & "'," & _
                                 dr.Item("cod_ruta").ToString & ",'" & dr.Item("direccion_calle").ToString.Replace("'", "").Trim & "'," & _
                                 dr.Item("direccion_zona").ToString & ",'" & dr.Item("direccion_colonia").ToString.Trim & "'," & _
                                 dr.Item("direccion_municipio").ToString & "," & dr.Item("direccion_departamento").ToString & "," & _
                                 dr.Item("direccion_pais").ToString & ",'" & dr.Item("telefono").ToString.Trim & "'," & dr.Item("estado").ToString & ",'" & _
                                 dr.Item("observaciones").ToString.Trim & "'," & dr.Item("orden_visita").ToString & "," & dr.Item("descuento").ToString & ",'" & _
                                 dr.Item("usuario_modifico").ToString & "','" & Date.Parse(dr.Item("fecha_modifico").ToString).ToString("yyyy-MM-dd HH:mm") & "'," & _
                                 dr.Item("cod_tipo_localidad_geo").ToString & "," & dr.Item("cod_sucursal").ToString & ")"
                        ...
                        If myOtrans.Codigo_error > 0 Then
                            Resultado = False
                        Else
                            odt_vendedores.DefaultView.RowFilter = "cod_cliente = " & dr.Item("cod_cliente").ToString & _
                                            "and cod_sucursal = " & dr.Item("cod_sucursal").ToString & _
                                            "and cod_cliente_mayorista = " & dr.Item("cod_cliente_mayorista").ToString
    ...
    Function Subir_Proveedores_XML(ByVal _odt As DataTable) As Boolean
        ...
        Try
            ...
            For Each dr In _odt.Rows
                ''Primero debe verificar si existe
                ls_sql = "call pa_sel_um_bbj_mayorista_proveedor (" & dr.Item("cod_cliente").ToString & "," & _
                        dr.Item("cod_proveedor_mayorista").ToString & ")"
                dt = myOtrans.Obtiene(ls_sql)

                If dt.Rows.Count = 0 Then
                    ls_sql = "call pa_ins_um_bbj_mayorista_proveedor_XML (" & dr.Item("cod_cliente").ToString & "," & _
                            dr.Item("cod_proveedor_mayorista").ToString & ",'" & dr.Item("nit").ToString & "','" & _
                            dr.Item("nombre_proveedor").ToString & "','" & dr.Item("contacto").ToString & "','" & _
                            dr.Item("telefono").ToString & "','" & dr.Item("observaciones").ToString & "','" & _
                            dr.Item("direccion_calle").ToString & "'," & dr.Item("direccion_zona").ToString & ",'" & _
                            dr.Item("direccion_colonia").ToString & "'," & dr.Item("direccion_municipio").ToString & "," & _
                            dr.Item("direccion_departamento").ToString & "," & dr.Item("direccion_pais").ToString & ",'" & _
                ...
                Else
                    Try
                        ...
                        ls_sql = "call pa_upd_um_bbj_mayorista_proveedor_XML (" & dr.Item("cod_cliente").ToString & "," & _
                                dr.Item("cod_proveedor_mayorista").ToString & ",'" & dr.Item("nit").ToString & "','" & _
                                dr.Item("nombre_proveedor").ToString & "','" & dr.Item("contacto").ToString & "','" & _
                                dr.Item("telefono").ToString & "','" & dr.Item("observaciones").ToString & "','" & _
                                dr.Item("direccion_calle").ToString & "'," & dr.Item("direccion_zona").ToString & ",'" & _
    ...
    Function Subir_Depositos_XML(ByVal _odt As DataTable) As Boolean
        ...
        Try
            myOtrans.open()
            For Each dr In _odt.Rows
                ls_sql = "call pa_sel_um_bbj_mayorista_deposito (" & dr.Item("cod_cliente").ToString & "," & _
                        dr.Item("cod_deposito").ToString & ")"
                dt = myOtrans.Obtiene(ls_sql)

                If dt.Rows.Count = 0 Then
                    ls_sql = "call pa_ins_um_bbj_mayorista_deposito_XML (" & dr.Item("cod_deposito").ToString & "," & _
                            dr.Item("cod_cliente").ToString & ",'" & dr.Item("banco").ToString & "','" & _
                            dr.Item("numero_boleta").ToString & "','" & Date.Parse(dr.Item("fecha").ToString).ToString("yyyy-MM-dd") & "'," & _
                            dr.Item("valor").ToString & ",'" & dr.Item("observaciones").ToString & "','" & _
    ...
    Function Subir_Mensajeria_XML(ByVal _dt As DataTable) As Boolean
        ...
        Try
            ...
            For Each dr In _dt.Rows
                ...
                ls_sql = "call pa_ins_um_bbj_mayorista_mensajeria_traslado (" & dr.Item("cod_cliente").ToString & ",'" & _
                                    dr.Item("importancia").ToString & "','" & dr.Item("asunto").ToString & "','" & _
                                    Date.Parse(dr.Item("fecha_envio").ToString).ToString("yyyy-MM-dd") & "','" & _
                                    dr.Item("observaciones").ToString & "','" & dr.Item("usuario_grabo") & "'," & dr.Item("envio_recepcion") & "," & _
                                    dr.Item("cod_mensaje") & ")"
                myOtrans.Ingresa(ls_sql)
            Next
                    ...
                    For Each dr2 In dt2.Rows
                        ...
                        If Not Ods.Tables.Contains("detalle_factura") Then
                            ...
                            For Each ocol In dt4.Columns ' iCount = 0 To ncol
                                If ocol.ColumnName.ToLower = "empresa" Or _
                                    ocol.ColumnName.ToLower = "tipodocto" Or _
                                    ocol.ColumnName.ToLower = "correlativo" Or _
                                    ocol.ColumnName.ToLower = "secuencia" Or _
                                    ocol.ColumnName.ToLower = "producto" Or _
                                    ocol.ColumnName.ToLower = "_unidades" Or _
                                    ocol.ColumnName.ToLower = "glosa" Or _
                                    ocol.ColumnName.ToLower = "total_docto" Or _
                                    ocol.ColumnName.ToLower = "cliente" Or _
                                    ocol.ColumnName.ToLower = "fecha_docto" Or _
                                    ocol.ColumnName.ToLower = "comentario1" Or _
                                    ocol.ColumnName.ToLower = "numero_docto" Or _
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                For Each dr In Ods.Tables("mensajeria").Rows
                    ls_sql = "call pa_upd_um_bbj_mayorista_mensajeria_traslado (" & _
                        dr.Item("cod_cliente").ToString & "," & _
                        dr.Item("cod_mensaje").ToString & "," & _
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                For Each dr In Ods.Tables("productos_aprobados").Rows
                    ls_sql = "call pa_upd_um_bbj_mayorista_productos_aprobados_traslado (" & _
                        dr.Item("cod_cliente").ToString & ",'" & _
...
#Region "Pedidos Web Umbright Mobile"
    ...
    Private Sub ObtenerPedidos_Tekne_Vendedor(ByVal drv As DataRowView)
        Dim ff As New FTP.clsFTP
        ...
        Try
            ...
            If (ff.Login()) Then
                ...
                ff.ChangeDirectory(drv.Item("carpeta").ToString)
                ff.ChangeDirectory(drv.Item("descripcion").ToString)
                    ...
                    For icount = 0 To archivos.Length - 1
                        If archivos(icount).ToLower.IndexOf("xml") > 0 Then
                            If ff.RenameFile(archivos(icount).Trim, "_" & archivos(icount).Trim) Then
                                ...
                                ff.DownloadFile("_" & archivos(icount).Trim, "c:\Aplicaciones\Umbright Mobile SE\Receive\_" & archivos(icount).Trim)
        ...
        Catch ex As System.Exception            '        
            ClsGen.Escribir_Log("Obtener_Pedidos_Tekne_Vendedor " & drv.Item("usuario"))
            ClsGen.Escribir_Log("Message from FTP Server was: " & ff.MessageString)
        Finally
            ff.CloseConnection()
            ff = Nothing
    ...
    Private Sub Guardar_Sincronizacion(ByVal usuario As String, ByVal fechai As DateTime, ByVal fechaf As DateTime, ByVal tipo As Integer, ByVal npedidos As Integer)
        ...
        Try
            myOtrans.open()
            ls_sql = "call pa_ins_um_mov_sincronizacion ('" & usuario & "','" & _
                            fechai.ToString("yyyy-MM-dd HH:mm:ss") & "','" & _
    ...
    Private Sub Guardar_LogVisita_Umbright_EE(ByVal pempresa As String, ByVal pusuario As String, _
                            ByVal pcliente As String, ByVal pnumeropedido As String, ByVal pfecha As DateTime, _
                         ByVal myotrans As Transaccional.Conexion_mysql)

        Dim ls_sql As String


        Try
            ''Buscar La Ruta para establecer si esta en el dia correcto
            ls_sql = ""



            ls_sql = "call pa_ins_um_mov_log_visita ('" & _
                       pempresa & "','" & _
                       pcliente & "','" & _
                       DateTime.Parse(pfecha.ToString).ToString("yyyy-MM-dd HH:mm:ss") & "','" & _
                       DateTime.Parse(pfecha.ToString).ToString("yyyy-MM-dd HH:mm:ss") & "',"

            'If pdr.Item("modulo").ToString.ToLower.StartsWith("pedido") Then
            ls_sql += "1,'" & pnumeropedido & "','',null,"
            ls_sql += "'" & pusuario & "','')"
    ...
    Private Sub Generar_Pedidos_Umbright_Mobile()
        ...
        Try
            dt = oSinc.Procesar_Pedidos_Umbright_Mobile()
            dt.DefaultView.RowFilter = "comentarios like '%cell%'"


            ''Genera Informacion de Ultimo Pedido
            If dt.DefaultView.Count > 0 Then

                Dim oEnvio As New Sincronizacion.Preparar_Informacion_Umbright_Mobile_SE
                For Each drv As DataRowView In dt.DefaultView
                    oEnvio.Generar_Informacion_Ultimo_Pedido_Umbright_Mobile_SE(drv.Item("cod_pedido"))
                    '   oEnvio.Generar_Informacion_Ultimo_Pedido_Umbright_Mobile_SE(3680)
                Next
    ...
    Private Function Procesar_Archivo_Umbright_Mobile_EE(ByVal nombre_archivo) As Boolean
        ...
        Try
            ...
            If sfecha.Length = 14 Then
                ...
                dfecha_creacion_sincronizacion = DateTime.Parse(sfecha.Substring(6, 2) & "-" & sfecha.Substring(8, 2) & "-" & _
                                                sfecha.Substring(10, 4) & " " & sfecha.Substring(4, 2) & ":" & _
                                                sfecha.Substring(2, 2) & ":" & sfecha.Substring(0, 2))
            Else
                Try
        ...
        Try
            ...
            For i As Integer = 0 To lsDetalle1.Length - 1
                If lsDetalle1(i).Length > 0 Then
                    lsSQL = "call pa_ins_um_mov_marcacion_noentrega_transporte ('" & _
                                            lsDetalle1(i).Split("|")(0) & "','" & lsDetalle1(i).Split("|")(1) & "','" & _
                                            lsDetalle1(i).Split("|")(2) & "','" & _
                                            lsDetalle1(i).Split("|")(3) & "','" & _
                                            lsDetalle1(i).Split("|")(4) & "','" & _
                                            lsDetalle1(i).Split("|")(5) & "','" & _
                                            lsDetalle1(i).Split("|")(6) & "','" & _
    ...
    Private Function Subir_MarcacionEntradaSalida_Transportes(ByVal psarchivoXML As String)
        ...
        Try
            ...
            For i As Integer = 0 To lsDetalle1.Length - 1
                If lsDetalle1(i).Length > 0 Then
                    lsSQL = "call pa_ins_um_mov_marcacion_entradasalida_transporte ('" & _
                                            lsDetalle1(i).Split("|")(0) & "','" & lsDetalle1(i).Split("|")(1) & "','" & _
                                            lsDetalle1(i).Split("|")(2) & "','" & _
                                            lsDetalle1(i).Split("|")(3) & "','" & _
                                            lsDetalle1(i).Split("|")(4) & "','" & _
        ...
        Try
            ...
            For Each archivoXML In ArchivosXML
                ...
                ElseIf archivoXML.ToLower.IndexOf("consignacion") > -1 Then
                    ...
                    Me.Procesar_ConsignacionesTekne(archivoXML)
                ...
                ElseIf archivoXML.ToLower.IndexOf("entradasalida") > -1 Then 'Merchandising
    ...
    Private Function Subir_MarcacionGps_Tiendas(ByVal psarchivoXML As String)
        ...
        Try
            ...
            For i As Integer = 0 To lsDetalle1.Length - 1
                If lsDetalle1(i).Length > 0 Then
                    lsSQL = "call pa_ins_um_mov_marcacion_merchandising ('" & _
                                            lsDetalle1(i).Split("|")(0) & "','" & lsDetalle1(i).Split("|")(1) & "','" & _
                                            lsDetalle1(i).Split("|")(2) & "','" & _
                                            lsDetalle1(i).Split("|")(3) & "','" & _
                                            lsDetalle1(i).Split("|")(4) & "','" & _
                ...
                For icount As Integer = 1 To 9
                    ...
                    If Not detalle Is Nothing Then
                        For Each lineas As String In detalle
                            linea = lineas.Split("|")
                            If linea.Length > 1 Then
                                ls_sql = "pa_ins_um_cliinven '" & linea(0) & sCodigoEmpresa & "','" & _
                                                ls_inv_asesor & "','" & linea(1) & sCodigoEmpresa & "'," & _
                                                linea(2).ToString()
                                ...
                                If oSysgold.Codigo_error > 0 Then
                                    lbExitoso = False
                                End If
                                ls_sql = "call pa_ins_um_mov_inventario_cliente ('" & encabezado(0) & "','" & _
            ...
            For Each dr As DataRow In dtEmpresa.Rows
                ...
                For Each drv As DataRowView In dtOrden.DefaultView
                    If bencabezado Then
                        ...
                        ls_sql += drv.Item("comentarios").ToString & "','" & _
                                "ADMIN" & "',1,'" & _
                ...
                If numero_pedido > 0 Then
                    ls_sql = "call pa_upd_mov_pedidos_encabezado_cell (" & numero_pedido & ")"
                    myOtrans.Actualiza(ls_sql)
                    ls_sql = "call pa_upd_maq_orden (" & dr.Item("empresa_vende").ToString & "','" & _
    ...
    Private Function Subir_Pedido_Temporal_Tekne(ByVal archivoXML As String)
        ...
        Try
            ...
            With dr_encabezado
                ...
                ls_sql = "call pa_ins_um_mov_pedidos_encabezado_tekne ('" & _
                         encabezado(0).ToString.ToUpper & "','" & encabezado(1).ToString & "','" & _
                         encabezado(2).ToString & "','" & FormaPago & "'," & _
                         "0,0,'" & _
                        DateTime.Parse(dFechaPedido.ToString).ToString("yyyy-MM-dd HH:mm") & "','" & _
                ...
                ls_sql += "tekne " & encabezado(4).ToString & "','" & _
                        encabezado(6).ToString.ToLower & "',1,'" & _
                        dtCliente.Rows(0).Item("ListaPrecio").ToString & "','" & _
                        dFecha_Creacion_Archivo.ToString("yyyy-MM-dd HH:mm:ss") & "',NULL,'"
                ...
                If myOtrans.Codigo_error = 0 Then
                        ...
                        If Not detalle Is Nothing Then
                            For Each lineas As String In detalle
                                ...
                                If linea.Length > 1 Then
                                    ...
                                    If linea(0).StartsWith(encabezado(0).ToString) Then
                                        ls_sql = "call pa_ins_um_mov_pedidos_detalle (" & numero_pedido & "," & _
                                                          linea(4) & ",'" & linea(2).ToString & "'," & _
                                                          linea(3) & "," & precio_unitario & "," & _
                    ...
                    Guardar_LogVisita_Umbright_EE(encabezado(0).ToString.ToUpper, encabezado(6).ToString, _
                    encabezado(2).ToString, encabezado(1).ToString, DateTime.Parse(dFecha_Creacion_Archivo.ToString).ToString("yyyy-MM-dd HH:mm:ss"), _
                        myOtrans)
    ...
    Private Function Subir_Pedido_Temporal_TekneOld10032014(ByVal archivoXML As String)
        ...
        Try
            ...
            With dr_encabezado
                ...
                ls_sql = "call pa_ins_um_mov_pedidos_encabezado_tekne ('" & _
                         encabezado(0).ToString.ToUpper & "','" & encabezado(1).ToString & "','" & _
                         encabezado(2).ToString & "','" & dtCliente.Rows(0).Item("Condpago").ToString & "'," & _
                         "0,0,'" & _
                        DateTime.Parse(dFechaPedido.ToString).ToString("yyyy-MM-dd HH:mm") & "','" & _
                        DateTime.Parse(dFechaPedido.ToString).ToString("yyyy-MM-dd") & "','"
    ...
    Private Function Subir_Encabezado_Temporal_Celular(ByVal archivoXML As String, ByRef CodigoCliente As String) As Integer
        ...
        Try
            ...
            With dr_encabezado
                ...
                ls_sql = "call pa_ins_um_mov_pedidos_encabezado ('" & _
                         .Item("empresa").ToString.ToUpper & "','" & .Item("numero_pedido").ToString & "','" & _
                         .Item("codigo_cliente").ToString & "','" & dtCliente.Rows(0).Item("Condpago").ToString & "'," & _
                         "0,0,'" & _
                        DateTime.Parse(dFecha_Creacion_Archivo.ToString).ToString("yyyy-MM-dd HH:mm") & "','" & _
                        DateTime.Parse(dFecha_Creacion_Archivo.ToString).ToString("yyyy-MM-dd") & "','"
                ...
                ls_sql += .Item("comentarios").ToString.Replace("|", " ") & " Prueba IT**','" & _
                        .Item("usuario_grabo").ToString & "',1,'" & _
                        dtCliente.Rows(0).Item("ListaPrecio").ToString & "','" & _
                        dFecha_Creacion_Archivo.ToString("yyyy-MM-dd HH:mm:ss") & "','" & _
    ...
    Private Function Subir_Detalle_Temporal_Celular(ByVal archivoXML As String, ByVal CodigoPedido As Integer, ByVal CodigoCliente As String, ByVal NumeroPedido As String) As Boolean
        ...
        Try
            ...
            ls_sql = "call pa_ins_um_mov_pedidos_detalle (" & CodigoPedido & "," & _
                   dr.Item("Linea") & ",'" & dr.Item("producto").ToString & "'," & _
                   dr.Item("Cantidad") & "," & precio_unitario & "," & _
    ...
    Private Function Subir_Encuesta_Temporal_Celular(ByVal psarchivoXML As String)
        ...
        Try
            ...
            lsSQL = "call pa_var_um_mov_encuesta_resultado_encabezado_numero ('" & _
                    lsDatos(0).Split("_")(0) & "'," & lsDatos(0).Split("_")(1) & ")"
            dt = myOtrans.Obtiene(lsSQL)
            If dt.Rows.Count > 0 Then
                lsSQL = "call pa_ins_um_mov_resultado_encuesta_encabezado ('" & _
                    lsDatos(0).Split("_")(0) & "'," & lsDatos(0).Split("_")(1) & "," & _
                    dt.Rows(0).Item("nuevo_numero").ToString & ",'" & _
                    lsDatos(1) & "','" & _
                    lsDatos(2) & "')"
                myOtrans.Ingresa(lsSQL)
                If myOtrans.Codigo_error = 0 Then
                    If lsDatos.Length > 3 Then
                        lsSQL = "call pa_upd_um_mov_resultado_encuesta_encabezado_gps ('" & _
                                lsDatos(0).Split("_")(0) & "'," & lsDatos(0).Split("_")(1) & "," & _
                                dt.Rows(0).Item("nuevo_numero").ToString & ",'" & _
                                lsDatos(3).Split(",")(0) & "','" & _
                                lsDatos(3).Split(",")(1) & "')"
                    ...
                    For i As Integer = 0 To lsDetalle.Length - 1
                        If lsDetalle(i).Length > 0 Then
                            ...
                            lsSQL = "call pa_ins_um_mov_resultado_encuesta_detalle_alternativa ('" & _
                                 lsDatos(0).Split("_")(0) & "'," & lsDatos(0).Split("_")(1) & "," & _
                                 dt.Rows(0).Item("nuevo_numero").ToString & "," & _
    ...
    Private Function Subir_Encuesta_Temporal_CelularNube(ByVal psarchivoXML As String)
        ...
        Try
            ...
            If lsDatos(8).ToString = 3 And lsDatos(9).ToString = 2 Then
                ...
                lsSQL = "call pa_upd_um_mov_resultado_encuesta_encabezado_incidencia_tk('" & _
            ...
            If lsDatos(8).ToString = 3 And lsDatos(9).ToString = 1 Then
                ...
                If dt.Rows.Count > 0 Then
                    CodTipoEncuesta = Val(lsDatos(8))
                    lsSQL = "call pa_ins_um_mov_resultado_encuesta_encabezado_tk ('" & _
                        lsDatos(0) & "'," & lsDatos(1) & "," & _
                        dt.Rows(0).Item("nuevo_numero").ToString & ",'" & _
                        lsDatos(3) & "','" & lsDatos(7) & "','" & lsDatos(9) & "','" & _
                    ...
                    If myOtrans.Codigo_error = 0 Then
                        ...
                        For i As Integer = 0 To lsDetalle1.Length - 1
                            If lsDetalle1(i).Length > 0 Then
                                ...
                                lsSQL = "call pa_ins_um_mov_resultado_encuesta_detalle_alternativa_tk ('" & _
                                     lsDatos(0) & "'," & lsDatos(1) & "," & _
                                     dt.Rows(0).Item("nuevo_numero").ToString & "," & _
    ...
    Private Function Subir_Pedido_Temporal(ByVal ods As DataSet, ByVal _NumeroPedido As String, _
        ...
        Try
            ...
            With dr_encabezado
                ls_sql = "call pa_ins_um_mov_pedidos_encabezado ('" & _
                        .Item("empresa").ToString & "','" & .Item("numero_pedido").ToString & "','" & _
                        .Item("ctacte").ToString & "','" & .Item("forma_pago").ToString & "'," & _
                        .Item("total_pedido").ToString & "," & .Item("total_lineas").ToString & ",'" & _
                        DateTime.Parse(.Item("fecha_pedido").ToString).ToString("yyyy-MM-dd HH:mm") & "','" & _
                ...
                ls_sql += .Item("comentarios").ToString & "','" & _
                        .Item("usuario_grabo").ToString & "'," & _
                        .Item("estado").ToString & ",'" & _
                        .Item("ListaPrecio").ToString & "','" & _
                ...
                If myOtrans.Codigo_error = 0 Then
                    ...
                    For Each drv As DataRowView In ods.Tables("pedidos_detalle").DefaultView
                        If drv.Item("numero_pedido") = dr_encabezado.Item("numero_pedido") Then
                            LineaLocal += 1
                            ls_sql = "call pa_ins_um_mov_pedidos_detalle (" & liCod_Pedido & "," & _
                                    LineaLocal & ",'" & drv.Item("producto").ToString & "'," & _
                                    drv.Item("Cantidad") & "," & drv.Item("precio") & "," & _
    ...
    Private Function Hacer_Pedido_Clase_Web(ByVal ods As DataSet, ByVal _NumeroPedido As String, ByVal dr_encabezado As DataRow, _
    ...
    Private Function Procesar_Conteos_Consignaciones(ByVal pdr As DataRow, ByVal _dt As DataTable)
        ...
        Try
            ...
            ls_sql = "call pa_ins_um_crm_cliente_producto_consignacion_conteo_encabezado(" & _
                        iCodEmpresa & ",'" & _
                        pdr.Item("ctacte").ToString & "','" & _
                        DateTime.Parse(pdr.Item("fecha_grabo").ToString).ToString("yyyy-MM-dd") & "','" & _
                        pdr.Item("comentarios_reposicion").ToString & "','" & _
                        pdr.Item("comentarios_factura").ToString & "','" & _
            ...
            If myOtrans.Codigo_error = 0 Then
                ...
                _dt.DefaultView.RowFilter = "empresa = '" & pdr.Item("empresa") & _
                                            "' and ctacte = '" & pdr.Item("ctacte") & _
                                            "' and cod_conteo = " & pdr.Item("cod_conteo")


                For Each drv In _dt.DefaultView
                    ls_sql = "call pa_ins_um_crm_cliente_producto_consignacion_conteo (" & _
                                iCodEmpresa & ",'" & _
                                drv.Item("ctacte").ToString & "','" & _
                                drv.Item("producto").ToString & "','" & _
                                DateTime.Parse(drv.Item("fecha_grabo").ToString).ToString("yyyy-MM-dd HH:mm") & "'," & _
                                drv.Item("cantidad").ToString & ",0,'" & _
...
#Region " Documentos Consignaciones"
    ...
    Private Function Generar_Documentos_Consignaciones() As Boolean
        ...
        Try
            ...
            For Each dr In ods.Tables("clientes_procesar").Rows
                ...
                Crear_Documento_Consignacion_Factura_Flex(ods.Tables("conteos_pendientes").DefaultView, dr.Item("cod_cliente").ToString, _
                    dr.Item("Comentarios_reposicion").ToString, dr.Item("Comentarios_factura").ToString, _
    ...
    Private Function Obtener_Saldo_Consignacion_Actual(ByVal _empresa As String, ByVal _producto As String, ByVal _cliente As String) As Integer
        Dim otrans As New Transaccional.Conexion("FlexLine")
        Dim dt As DataTable
        Dim ls_Sql As String
    ...
    Private Sub Crear_Documento_Consignacion_Factura_Flex(ByVal _dv As DataView, ByVal _cod_cliente As String, _
                ByVal _comentario_consignacion As String, ByVal _comentario_factura As String, _
        ...
        Try
            ...
            For Each drv In _dv 'Ods.Tables("Conteos_Pendientes").DefaultView
                If drv.Item("cantidad_consignar") > 0 Then
                    ...
                    dr2.Item("Bodega") = "CONSIGNACIONES"
                ...
                If drv.Item("cantidad_facturar") > 0 Then
                    ...
                    dt = Obtener_Consignacion_Facturar(_cod_cliente, _
                                                    drv.Item("cod_producto"), _
                                                    drv.Item("cantidad_facturar"), _dv(0).Item("empresa").ToString, _
            ...
            Oflex.Guardar_Documento()
            Oflex_Facturar.Guardar_Documento()


            'Oflex.Guardar_PedidoBasico()
            'Oflex_Facturar.Guardar_PedidoBasico()
            myOtrans.open()

            'Ods.Tables("conteos_pendientes").DefaultView.RowFilter = ""
            For Each drv In _dv 'Ods.Tables("Conteos_Pendientes").DefaultView
                'If drv.Item("procesar").ToString = True Then
                myOtrans.Actualiza("call pa_upd_um_crm_cliente_producto_consignacion_conteo_proceso (" & _
                                    drv.Item("cod_empresa").ToString & ",'" & _
                                    drv.Item("cod_cliente").ToString & "','" & _
    ...
    Private Function Obtener_Consignacion_Facturar(ByVal _cod_cliente As String, _
                                                     ByVal _cod_producto As String, _
                                                     ByVal _cantidad As Integer, _
...
#End Region
    ...
    Private Function Procesar_Log_Actividades55(ByVal pdr As DataRow) As Boolean
        ...
        Try
            ...
            ElseIf pdr.Item("modulo").ToString.ToLower.StartsWith("consig") Then
                ls_sql += "10"
            End If
            ls_sql += ",'" & DateTime.Parse(pdr.Item("fecha_actividad").ToString).ToString("yyyy-MM-dd HH:mm:ss") & "','" & _
                    DateTime.Parse(pdr.Item("fecha_final").ToString).ToString("yyyy-MM-dd HH:mm:ss") & "','" & _
                    pdr.Item("ctacte").ToString & pdr.Item("empresa").ToString.Substring(0, 3) & "','" & _
                    pdr.Item("numero_pedido").ToString & "','" & _
    ...
    Private Function Procesar_Log_Actividades(ByVal pdr As DataRow, ByVal dt As DataTable) As Boolean
        ...
        Try
            ...
            ls_sql = "call pa_ins_um_mov_log_visita ('" & _
                    pdr.Item("empresa") & "','" & _
                    pdr.Item("ctacte") & "','" & _
                    DateTime.Parse(pdr.Item("fecha_actividad").ToString).ToString("yyyy-MM-dd HH:mm:ss") & "','" & _
    ...
    Private Function Procesar_NoVenta(ByVal dr As DataRow) As Boolean
        ...
        Try
            Otrans.open()
            ls_sql = "pa_ins_um_novisita '" & dr.Item("usuario_sysgold") & dr.Item("empresa").ToString.Substring(0, 3) & "','" & _
                dr.Item("ctacte").ToString & dr.Item("empresa").ToString.Substring(0, 3) & "','" & _
                DateTime.Parse(dr.Item("fecha").ToString).ToString("yyyy-MM-dd") & "','" & _
                dr.Item("cod_motivo").ToString.PadLeft(2, "0") & "','" & _
                DateTime.Parse(dr.Item("fecha").ToString).ToString("yyyy-MM-dd HH:mm:ss") & "'," & _
    ...
    Private Function Procesar_Inventario_Cliente(ByVal pdt As DataTable)
        ...
        Try
            ...
            For Each dr In pdt.Rows
                ls_sql = "pa_ins_um_cliinven '" & dr.Item("ctacte").ToString & dr.Item("empresa").ToString.Substring(0, 3) & " ','" & _
                            dr.Item("usuario_sysgold") & dr.Item("empresa").ToString.Substring(0, 3) & "','" & dr.Item("producto").ToString & dr.Item("empresa").ToString.Substring(0, 3) & "'," & _
                            dr.Item("existencia") & ",'" & DateTime.Parse(dr.Item("fecha_grabo").ToString).ToString("yyyy-MM-dd HH:mm:ss") & "'"

                oTrans.Ingresa(ls_sql)

                ls_sql = "call pa_ins_um_mov_inventario_cliente ('" & dr.Item("empresa") & "','" & _
...
#Region "EdiFact"
                ...
                If dtaux.Rows.Count > 1 Then
                    ...
                    For Each ddr As DataRow In dtaux.Rows
                        If ddr.Item("LugarEntregaGLN").ToString.Length > 0 Then
                            ...
                            ls_sql = "call pa_ins_edi_pedidos_encabezado('CODICASA','" & ddr.Item("idtransaccion") & "','" & dr.Item("idempresacadena") & "','" & _
                                                           dr.Item("idempresaproveedor") & "','" & ddr.Item("LugarEntregaGLN") & "','" & _
                                                           dr.Item("idempresalocalproveedor") & "','" & Date.Parse(dr.Item("fechahora").ToString).ToString("yyyy-MM-dd hh:ss:mm") & "','" & _
                                                           Date.Parse(dr.Item("fechahoraentrega").ToString).ToString("yyyy-MM-dd hh:ss:mm") & "','" & Date.Parse(dr.Item("fechahoravencimiento").ToString).ToString("yyyy-MM-dd hh:ss:mm") & "','" & _
                                                           dr.Item("tipoorden") & "','" & dr.Item("observaciones") & "','" & _
                                                           dr.Item("departamentoventas") & "','" & dr.Item("referenciadepromocion") & "','" & _
                            ...
                            If myOtrans.Codigo_error = 0 Then
                                ...
                                For Each drv2 As DataRowView In odataset.Tables("pedidos_detalle").DefaultView '. Count '- 1
                                    ...
                                    ls_sql = "call pa_ins_um_edi_pedido_detalle('" & drv2.Item("idtransaccion") & "','" & drv2.Item("idproducto") & "','" & _
                                                                    ...
                                                                    drv2.Item("idproductoproveedor") & "'," & drv2.Item("cantidadunidades") & "," & drv2.Item("bonificacionunidades") & "," & _
                                                                    drv2.Item("costonegociado") & ",'" & drv2.Item("empaquecantidadcontenida") & "','" & drv2.Item("empaquetipo") & "','" & _
                                                                    ddr.Item("cruceAndenGLN") & "','" & drv2.Item("cruceAndenDividir") & "','" & drv2.Item("idcomprador") & "','" & _
        ...
        Try
            ...
            For Each dr As DataRow In odataset.Tables("pedidos").Rows
                ...
                Else
                    ...
                    ls_sql = "call pa_ins_edi_pedidos_encabezado('CODICASA','" & dr.Item("idtransaccion") & "','" & dr.Item("idempresacadena") & "','" & _
                                                                               dr.Item("idempresaproveedor") & "','" & glnLugarEntrega & "','" & _
                                                                               dr.Item("idempresalocalproveedor") & "','" & Date.Parse(dr.Item("fechahora").ToString).ToString("yyyy-MM-dd hh:ss:mm") & "','" & _
                                                                               Date.Parse(dr.Item("fechahoraentrega").ToString).ToString("yyyy-MM-dd hh:ss:mm") & "','" & Date.Parse(dr.Item("fechahoravencimiento").ToString).ToString("yyyy-MM-dd hh:ss:mm") & "','" & _
                                                                               dr.Item("tipoorden") & "','" & dr.Item("observaciones") & "','" & _
                                                                               dr.Item("departamentoventas") & "','" & dr.Item("referenciadepromocion") & "','" & _
                ...
                If dtaux.Rows.Count > 1 Then 'Reparticion, Varias Ordenes con el Mismo Numero y Diferente Tienda
                    ...
                    For Each ddr As DataRow In dtaux.Rows
                        If ddr.Item("LugarEntregaGLN").ToString.Length > 0 Then
                            ...
                            dt_rows = odataset.Tables("pedidos_detalle")
                            dt_rows.DefaultView.RowFilter = "LugarEntregaGLN = '" & ddr.Item("LugarEntregaGLN").ToString & "'"
                            ls_sql = "call pa_ins_edi_pedidos_encabezado('DMARTE1','" & ddr.Item("idtransaccion") & "','" & dr.Item("idempresacadena") & "','" & _
                                                           dr.Item("idempresaproveedor") & "','" & ddr.Item("LugarEntregaGLN") & "','" & _
                                                           dr.Item("idempresalocalproveedor") & "','" & Date.Parse(dr.Item("fechahora").ToString).ToString("yyyy-MM-dd hh:ss:mm") & "','" & _
                                                           Date.Parse(dr.Item("fechahoraentrega").ToString).ToString("yyyy-MM-dd hh:ss:mm") & "','" & Date.Parse(dr.Item("fechahoravencimiento").ToString).ToString("yyyy-MM-dd hh:ss:mm") & "','" & _
                                                           dr.Item("tipoorden") & "','" & dr.Item("observaciones") & "','" & _
    ...
    Private Sub obtener_pedidos_access_diuva(ByVal ipProceso As Integer)
        ...
        Try
            ...
            For Each dr As DataRow In odataset.Tables("clientes").Rows
                ls_sql = "call pa_ins_edi_cliente('DIUVA','" & dr.Item("idempresalocal") & "','" & dr.Item("idempresa") & "','" & dr.Item("GLN") & "','" & dr.Item("descripcion") & "','" & _
                     dr.Item("nombre") & "','" & dr.Item("direccion1") & "','" & dr.Item("direccion2") & "','" & dr.Item("direccion3") & "','" & _
                      dr.Item("ciudadmunicipio") & "','" & dr.Item("departamento") & "','" & dr.Item("codigopostal") & "','" & dr.Item("paisiso") & "','" & dr.Item("tipodestino") & "','" & dr.Item("nombrecontacto") & "')"
                myOtrans.Ingresa(ls_sql)
            ...
            For Each dr As DataRow In odataset.Tables("pedidos").Rows
                ...
                If dtaux.Rows.Count > 1 Then
                    ...
                    For Each ddr As DataRow In dtaux.Rows
                        If ddr.Item("LugarEntregaGLN").ToString.Length > 0 Then
                            ...
                            dt_rows = odataset.Tables("pedidos_detalle")
                            dt_rows.DefaultView.RowFilter = "LugarEntregaGLN = '" & ddr.Item("LugarEntregaGLN").ToString & "'"
                            ls_sql = "call pa_ins_edi_pedidos_encabezado('DIUVA','" & ddr.Item("idtransaccion") & "','" & dr.Item("idempresacadena") & "','" & _
                                                           dr.Item("idempresaproveedor") & "','" & ddr.Item("LugarEntregaGLN") & "','" & _
                                                           dr.Item("idempresalocalproveedor") & "','" & Date.Parse(dr.Item("fechahora").ToString).ToString("yyyy-MM-dd hh:ss:mm") & "','" & _
                                                           Date.Parse(dr.Item("fechahoraentrega").ToString).ToString("yyyy-MM-dd hh:ss:mm") & "','" & Date.Parse(dr.Item("fechahoravencimiento").ToString).ToString("yyyy-MM-dd hh:ss:mm") & "','" & _
                                                           dr.Item("tipoorden") & "','" & dr.Item("observaciones") & "','" & _
                ...
                Else ''Solo 1 Lugar de Entrega
                    ...
                    ls_sql = "call pa_ins_edi_pedidos_encabezado('DIUVA','" & dr.Item("idtransaccion") & "','" & dr.Item("idempresacadena") & "','" & _
                                                                               dr.Item("idempresaproveedor") & "','" & glnLugarEntrega & "','" & _
                                                                               dr.Item("idempresalocalproveedor") & "','" & Date.Parse(dr.Item("fechahora").ToString).ToString("yyyy-MM-dd hh:ss:mm") & "','" & _
                                                                               Date.Parse(dr.Item("fechahoraentrega").ToString).ToString("yyyy-MM-dd hh:ss:mm") & "','" & Date.Parse(dr.Item("fechahoravencimiento").ToString).ToString("yyyy-MM-dd hh:ss:mm") & "','" & _
                                                                               dr.Item("tipoorden") & "','" & dr.Item("observaciones") & "','" & _
...
#End Region
    ...
    Private Sub GeneraBDsqliteSE_Transportes(ByVal user As String, ByVal psNumeroControl As String)
        Dim myOtrans As New Transaccional.Conexion_mysql("OnBase")
        Dim Otrans As New Transaccional.Conexion("Flexline")
        ...
        Try
            ...
            SQLcommand.ExecuteNonQuery()
            '-*--------------------------------------------------------------DOCUMENTOS--------------------------------------
            ls_sql = "pa_sel_um_gen_control_tk '0000054544'"
    ...
    Private Sub frm_sincronizacion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'clsGen.Escribir_Log("Obtener_Pedidos_Umbright_Mobile_SE()")
        Obtener_Pedidos_Umbright_Mobile_SE() 'Standar Edition Celulares
        'clsGen.Escribir_Log("Obtener_Pedidos_Tekne")
        Obtener_Pedidos_Tekne()
        'clsGen.Escribir_Log("Obtener_Pedidos_Tekne_Mobile_EE")
        Obtener_Pedidos_Tekne_Mobile_EE() 'Android Tablet

        'clsGen.Escribir_Log("Obtener_Pedidos_Teken_Mobile_SE")
        Obtener_Pedidos_Tekne_Mobile_SE()

        obtener_informacion_transporte_mobile()

        'clsGen.Escribir_Log("Procesar_Archivo_Umbright_Mobile_SE")
        Procesar_Archivo_Umbright_Mobile_SE()
        'clsGen.Escribir_Log("revision_facturacion_costo")
        revision_facturacion_costo()
        ...
        'clsGen.Escribir_Log("obtenerConteosFisicos")
        obneterConteosFisicos() 'Conteos Fisicos
        'clsGen.Escribir_Log("procesarRecepcionConteosFisicos")
        procesarRecepcionConteosFisicos()
        Me.Close()
    End Sub
End Class
